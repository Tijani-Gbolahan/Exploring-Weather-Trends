...
plt.grid(True)
plt.plot(moving_avg['year'], moving_avg['mov_avg_city'], label='London')
plt.legend(loc='upper left')
plt.xlabel("Year (C.E.)")
plt.ylabel("Temperature (°C)")
plt.title("Temperature in London ({} year moving average)".format(average_span))
plt.show()
plt.close()
...
plt.xlabel("Year (C.E.)")
plt.ylabel("Temperature (°C)")
plt.title("Temperature in London Vs  Global values ({} year moving average)".format(average_span))
plt.show()
plt.close()
